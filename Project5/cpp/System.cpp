...
double System2::potential(double r1, double r2,double r12){
  return 0.5*omega*omega*(r1*r1+r2*r2)+1.0/r12;
}
double System1::potential(double r1, double r2,double r12){
  return 0.5*omega*omega*(r1*r1+r2*r2)+1.0/r12;
}
...
double System2::function(double r1, double r2, double r12){
      return (system1.function(r1,r2,r12))*exp(r12/(2.0*(1.0+beta*r12)));
    }
