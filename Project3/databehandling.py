...
print(monteGood_vectorized_noparallel)
monteGood_n_short=np.unique(monteGood_novectorized_noparallel[:,3]).astype(np.int)
...
print(np.asarray(time_novectorized_noparallel))
print(np.asarray(time_novectorized_parallel[:6]))
print(monteGood_n[:6],rel)
